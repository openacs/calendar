...
ad_proc cal_ics_date_time_format {date_time} {takes date_time in YYYYMMDD-HHMISS format and translates to msoutlook's preferred ics format} {
    # most of the work is actually being done by the to_char
    # in the query that sets up the value for date_time
    regsub -- {-} $date_time "T" new_date_time
    append new_date_time "Z"
