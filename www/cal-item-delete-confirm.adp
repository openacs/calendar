      ...
      <tr>
        ...
        <td valign=top> 
          <table>
            <tr>
              <td colspan=2>
                <blockquote>@cal_item.description@</blockquote>
              </td>
            </tr>
            <tr>
              <th align=right>
          ...
          <p>
            ...
            <else>
              ...
              <ul>
                <li> <a href="cal-item-delete?cal_item_id=@cal_item_id@&confirm_p=1">#calendar.yes_delete_it#</a></li>
                <li> <a href="cal-item-view?cal_item_id=@cal_item_id@">#calendar.no_keep_it#</a></li>
              </ul>
            </else>
        </td>
      </tr>
