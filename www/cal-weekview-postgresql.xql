...
as       day_of_the_week,
         to_char(next_day(to_date(:current_date, 'yyyy-mm-dd') - cast(7 as interval), 'SUNDAY'), 'YYYY-MM-DD') 
as       sunday_of_the_week,
         to_char(next_day(to_date(:current_date, 'yyyy-mm-dd') + cast(7 as interval), 'Saturday'), 'YYYY-MM-DD') 
