...
<table class="cal-table-display" cellpadding="0" cellspacing="0" border="0" width="75%" summary="calendar grid display for @month_string@ @year@">
  <tr>
    <multiple name="weekday_names">
      <th width="10%" class="cal-month-day-title">
        ...
        <tbody>
            ...
            <multiple name="items">
              ...
              <if @items.outside_month_p@ true>
                <td class="cal-month-day-inactive" width="10%">&nbsp;</td>
              </if>     
              <else>
                <if @items.today_p@ true>
                  <td class="cal-month-today"  width="10%" onclick="javascript:location.href='@items.add_url@';" onkeypress="javascript:acs_KeypressGoto('@items.add_url@',event);">
                </if>
                <else>
                  <td class="cal-month-day"  width="10%" onclick="javascript:location.href='@items.add_url@';"onkeypress="javascript:acs_KeypressGoto('@items.add_url@',event);">
                </else>
