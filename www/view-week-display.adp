    ...
    <thead>
      <tr>
        ...
        <multiple name="days_of_week">
          <th id="@days_of_week.day_short@" style="width:@days_of_week.width@@width_units@">
      ...
      <multiple name="grid">
		<tr>
          <if @grid.rownum@ odd>
            ...
            <multiple name="days_of_week">
              <td headers="@days_of_week.day_short@" class="week-event-2"></td>
            </multiple>
          </if>
          <else>
			<td headers="hours"><div class="day-time-1"><p>@grid.hour@</p></div></td>
            <multiple name="days_of_week">
              <td headers="@days_of_week.day_short@" class="week-event-1"></td>
            </multiple>
          </else>
		</tr>
      </multiple>
